                                                ...
                                                <Select value={editPayload.zone_id || 'none'} onValueChange={(v) => {
                                                    ...
                                                    <SelectContent className="bg-popover z-[10050]">
                                                        ...
                                                        <SelectItem value="__add_new" className="text-primary font-semibold">
                                                            <span className="flex items-center gap-1"><Plus className="w-3.5 h-3.5" /> إضافة منطقة لـ <span className="text-foreground">{sectors.find(s => s.id === editPayload.sector_id)?.name || 'السكتور'}</span></span>
                                                        </SelectItem>
                                                    </SelectContent>
                                                </Select>
                                            )}
